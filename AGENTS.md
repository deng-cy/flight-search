...
- Keep the round-trip search strategy documented in `docs/search_strategy.md`: one-way legs are combinable inventory, and true round-trip/open-jaw searches are added only for providers that can price a complete trip differently.
